...
.gettimestart:
	mov rax, 96		 ; Syscall 96 time of day
	mov rdi, mytime
	mov rsi, 0
	syscall
...
;	mov r12			 ; Max number of primes is r12
...
.primecheck:	
	...
	mov rax, rbx 	 ; Move approx sqrt to rax
	mul rbx			 ; Square the approx sqrt 
	cmp rax, r13
	jl .sqrtinc
...
.primecheckcont:
	...
	cmp r14, rbx 	 ; See if the divisor is the same as the approx sqrt
...
.sqrtinc:
	inc rbx 	  	 ; Approx sqrt + 1
	jmp .primecheckcont

.error:
	mov rax, 0
	mov rax, 2 		 ; Error for no argument
