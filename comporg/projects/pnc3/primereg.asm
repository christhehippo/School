...
.time: 				 ; Initial setup
	...
	; 
		...
		; It seems the time and atoi parts were my downfall here
		; but everythong else is fine I think
...
;	mov r8, [rax]   ; I think this copies the address contents
		
					 
	mov rax, 0

.initialvalues:
	mov r12, 1000	 ; Max number of primes
