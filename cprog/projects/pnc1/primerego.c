/////////////////////////////////////////////////////////////////////////////////////
// Primerego.c - brute force calculation of prime numbers BUT ONLY ODDS
// 
...
int main(int argc, char **argv)
{
	...
	for (forOne = lowerBound; forOne <= upperBound; forOne = forOne + 2)
	{
		
		//start second loop at 2, divided into forOne, then increase
		for (forTwo = 3; forTwo <= forOne; forTwo++)
		{
